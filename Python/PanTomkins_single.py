...
ax_6.plot(x6)
resss.plot(data_source)
# print R_loc
resss.plot([i for i in R_loc if i < len(data_source)], [data_source[i] for i in R_loc if i < len(data_source)], 'r')
